...
const DrawMovie = () => {
    return (
        <div className="w-full relative">
            ...
            <BgImage url="https://www.themoviedb.org/t/p/original/sQ5NKzWIusrpkv6Vq1V6GT0LHCh.jpg" />
                ...
                <div className="container mx-auto px-5">
                    ...
                    <div className="flex mt-10 gap-10 lg:gap-20 flex-col lg:flex-row pt-6 ">
                        <div className="flex gap-3 flex-col lg:w-[370px]">
                            <h1 className="text-4xl lg:text-5xl uppercase font-semibold">Filmy online</h1>
                            <p className="text-xl font-light">Znajdź film do obejrzenia online</p>
                        </div>
                    </div>
