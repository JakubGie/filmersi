...
async function getMovies(id) {
  const res = await fetch('https://api.filmer.wkbdhkmuzv.cfolks.pl/countryTv/' + id )
...
export async function generateMetadata({params}) {
  ...
  return {
    title: "Popularne seriale z kraju "+countryInfo.nazwa+" - Top Lista",
    description: "Sprawdź top listę popularnych seriali z kraju "+countryInfo.nazwa+" i oglądaj seriale online.",
    openGraph: {
      ...
      <div className="w-full relative">
        ...
        <div className="absolute w-full">
            ...
            <div className="container mx-auto px-5">
                ...
                <HeaderWithText header={countryInfo.nazwa} description={`SERIALE`} />
